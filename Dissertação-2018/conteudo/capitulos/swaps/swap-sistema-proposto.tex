...
% A estrutura de dados interna é o resultado dos processos de segmentação e extração de tópicos. Constituída pelos documentos originais, pelos segmentos de texto e pelas matrizes documento-tópico e tópico-termo.





$S_j$ conjunto de sub-documentos gerados pela segmentação do documento $d_j$.
