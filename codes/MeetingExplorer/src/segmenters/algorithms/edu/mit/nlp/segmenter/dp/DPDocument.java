...
import segmenters.algorithms.edu.mit.nlp.segmenter.Document;
import segmenters.algorithms.edu.mit.util.JacobUtil;
import segmenters.algorithms.edu.mit.util.stats.*;

/**
   Extends {@link segmenters.algorithms.edu.mit.nlp.segmenter.Document} with some methods
   specifically for the DP implementation of Bayesian segmentation.
   This class does not take advantage of {@link segmenters.algorithms.edu.mit.util.ling.CountsManager} 
