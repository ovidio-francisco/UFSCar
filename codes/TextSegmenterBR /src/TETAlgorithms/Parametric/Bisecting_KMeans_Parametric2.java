 ...
 * @author Gaia
 */
public class Bisecting_KMeans_Parametric2 extends TopicExtractor{
    ...
    public Bisecting_KMeans_Parametric2(int numDocs, int numTerms, int numTopics, int numMaxIteracoes, double minimunDifference, boolean centroidLabeling){
