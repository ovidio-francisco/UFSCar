...
public abstract class TopicExtractor {
    ...
    public TopicExtractor(int numDocs, int numTerms, int numTopics){
    ...
    public void setDocTopicMatrix(double[][] docTopic){
        this.docTopic = docTopic;
    }
    
    public void setTermTopicMatrix(double[][] termTopic){
