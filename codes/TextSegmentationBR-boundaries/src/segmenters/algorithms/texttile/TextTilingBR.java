package segmenters.algorithms.texttile;
...
public void findBoudaries() {
	...
	System.out.println(String.format("%s :: %s", "TextTiling", "findBoudaries() "));


	setSource(getEOSMarkedText());
	segmentation();

	System.out.println("tt::segmentation.size = " + segmentation.size());
