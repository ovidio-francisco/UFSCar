...
public class EvaluateSegmentationsFrame extends JFrame {
	...
	private JButton   btTests4_1     = new JButton("Create TeX Table");
	private JButton   btTests4_3     = new JButton("Create CSV");
	private JButton   btTests4_2     = new JButton("Show Results");
	...
	private static JCheckBox cbStems        = new JCheckBox("Extract Stems", false);
	...
	public EvaluateSegmentationsFrame() {
		...
		setTitle("Text Segmentation Tool (Br)");
...
//				}
		...
		btTests4_3.addActionListener(new ActionListener() {
