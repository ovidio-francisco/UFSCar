package segmenters.algorithms.edu.mit.nlp.segmenter.dp;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import segmenters.algorithms.edu.mit.nlp.segmenter.SegResult;
import segmenters.algorithms.edu.mit.util.JacobUtil;
import segmenters.algorithms.edu.mit.util.stats.FastDigamma;
import segmenters.algorithms.edu.mit.util.stats.FastDoubleGamma;
import segmenters.algorithms.edu.mit.util.stats.FastGamma;
import segmenters.algorithms.edu.mit.util.stats.Stats;
import segmenters.algorithms.edu.mit.util.weka.LBFGSWrapper;
