...
% As atas registram assuntos discutidos em reuniões e podem ser utilizadas como base de dados.
	% \item Registram assuntos discutidos em reuniões;
\nblock{}{
\begin{itemize}
	\item As atas registram assuntos discutidos em reuniões;
	\item Uma ata pode conter diversos assuntos discutidos.
\end{itemize}
}
...
\begin{itemize}
	\item Um assunto pode ser discutido em diversas reuniões ao longo do tempo;
	\item Recuperar o histórico de um assunto pode apoiar tomadas decisão.
\end{itemize}
}


\nblock{}{
% Devido às características das atas:
\begin{itemize}
...
\end{itemize}
	...
	% \item Podem tratar de diferentes assuntos no mesmo documento;
...
\begin{itemize}
	\item Apresentar uma ata integral pode dificultar o usuário encontrar determinado assunto;
	\item É desejável agrupar trechos de atas com assuntos semelhantes.
\end{itemize}
...
\begin{itemize}
	\item Dividem um texto em trechos com um único assunto completo;
...
\begin{itemize}
	...
	\item Medidas de desempenho; 
		\begin{itemize}
			\item Acurácia e F$^1$; 
			\item WindowDiff e P$_k$.
		\end{itemize}
