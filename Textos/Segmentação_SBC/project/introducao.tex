...
%%% 
Localizadas as palavras-chave as ferramentas desse tipo apresentam ao usuário um documento com as palavras buscadas em destaque, mantendo o texto longo. 
%
...
%
A sumarização de texto pode ser aprimorada ao processar segmentos separados por tópicos ao invés de documentos inteiros~\cite{Boguraev2000,Boguraev2000b,Dias2007}. 
...
Na Seção~\ref{sec:avaliacao} é detalhado a avaliação dos experimentos e seus resultados são reportados. 
%
