...
%%%%%%%%%%
Diferenças de performance podem ser vistas no mesmo algoritmo quando aplicando em documentos de diferentes idiomas, onde o inglês apresenta um taxa de erro significativamente menor que outro como o alemão e o espanhol~\cite{Kern2009,Sitbon2004}.
%
%
%%%%%%%%%%
% Foco nas atas
