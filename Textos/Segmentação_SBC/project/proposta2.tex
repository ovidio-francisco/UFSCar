...
%%%%%%%%%%
Os algoritmos \textit{TextTiling} e \textit{C99} foram propostos para o inglês, 
% independentemente de domínio, 
ou seja, a proposta inicial dos autores é trabalhar em qualquer texto nessa língua.
%%%%%%%%%%
% Adapatar para Atas em português
%%%%%%%%%%
Neste trabalho, esses algoritmos foram aplicados em atas de reunião escritas em português, ou seja, em uma língua diferente e dentro de um contexto específico. As implementações dos algoritmos, bem como ferramentas utilizadas e os resultados completos estão disponíveis para utilização e consulta em \urlsoftwares. As subseções seguintes tratam da aplicação desses algoritmos para esse nicho mais específico. 
% TODO: Melhorar
...
As atas a serem segmentadas são extraídas de documentos do tipo \textit{pdf}, \textit{doc}, \textit{docx} ou \textit{odt} que normalmente possuem formato binário. Aplicou-se um processo para transformar esses arquivos em texto plano.
% 
% A fim de extrair o texto desses documentos, aplicou-se um processo que transforma esses formatos em aquivos de texto plano. 
