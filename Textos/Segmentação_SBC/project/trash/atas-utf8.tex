...
% Cabeçalhos, rodapés, numeração de linhas, 
...
% Segundo Choi~\cite{Choi2001-LSA}, o segmentador tem a acurácia reduzida em segmentos curtos (em torno de 3 a 5 sentenças). % Já te vi 
% 		
% Para evitar um texto monótono à leitura, 
Ao redigir o documento tem-se o cuidado de não repetir ideias e palavras.
% em favor da elegância do documento. 
