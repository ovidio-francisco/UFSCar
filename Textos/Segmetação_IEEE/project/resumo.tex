...
%%%
Este artigo concentra-se nos principais algoritmos da literatura adaptando-os ao contexto das atas de reunião em português, bem como encontrar uma técnica que ofereça segmentos coesos e contribua para aprimorar sistemas de recuperação de informação para que respondam melhor à buscas do usuário.
%
