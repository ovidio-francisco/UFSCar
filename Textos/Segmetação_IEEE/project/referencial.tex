...
Inicialmente é construída uma matriz que contém as similaridades de todas as unidades de texto. Em seguida, cada valor na matriz de similaridade é substituído por seu ranking local. Onde para cada elemento da matiz, seu \textit{ranking} é o número de elementos vizinhos com valor de similaridade menor que o seu.%, o qual é calculado com a Equação~\ref{equ:ranklocal}. 

% O que é a máscara
Então, para cada elemento delimita-se uma região da matriz, chamada pelo autor de máscara, para comparar com seus vizinhos.
%
...
A fim de contornar esses problemas, algumas soluções foram propostas. Entre as medidas mais utilizadas para avaliar segmentadores estão:
