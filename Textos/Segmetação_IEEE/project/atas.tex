...
Para a condução desse trabalho é necessário que hajam documentos a serem segmentados automaticamente e que se conheça uma segmentação de referência para compará-los e avaliar a proposta. A seguir, é apresentado as caraterísticas particulares das atas em relação a outros tipos textos e a segmentação de referência a ser utilizada.
