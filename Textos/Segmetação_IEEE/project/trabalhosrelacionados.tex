...
%%%%%%%%%%
%A proposta é adaptar os algoritmos tradicionais à segmentação de atas de reunião em português, bem como encontrar um modelo que melhor se ajuste a esse contexto. 

%Semelhante a este trabalho, outras abordagens foram propostas como mostradas a seguir.
