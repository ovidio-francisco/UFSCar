...
%Removing Accents     
%Removing StopWords   
%MÉDIA  --------------------> DOCS: 548.000 | SENTENÇAS: 29.520
%
%Removing Numbers     
%MÉDIA  --------------------> DOCS: 471.500 | SENTENÇAS: 25.443
%
%Removing Shorters    
...
% 2 - Remoção de cabeçalho
% 3 - Divisão em sentenças
% 4 - Remoção de pontuação, acentos
% 5 - Remoção de StopWords
% 6 - Remoção de Numerais
% 7 - Remoção de palavras menores
% 8 - Remoção de Sufixos
