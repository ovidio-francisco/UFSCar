...
% ---
\titulo{Aplicação de técnicas de Mineração de Textos para Organização e Extração de Históricos de Decisões de Documentos de Reuniões}
...
%=============================== sumario =============================================
z\pdfbookmark[0]{\contentsname}{toc}
\tableofcontents*
\cleardoublepage
