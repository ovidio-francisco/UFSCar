...
\begin{figure}
\center
	\includegraphics[trim={ 0 0 0 0 },clip,page=1,width=0.8\textwidth]{conteudo/capitulos/figs/janelas-deslizantes.pdf}
...
Um limite ou transição entre segmentos é identificado sempre que a similaridade entre as unidades que antecedem e precedem o ponto candidato cai abaixo de um limiar, ou seja, identifica-se uma transição entre segmentos pelos vales na curva de dissimilaridade.
