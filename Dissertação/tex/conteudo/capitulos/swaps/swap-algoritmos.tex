...
Um dos primeiros algoritmos a aplicar essa técnica para segmentação textual foi proposto por Kosima. Em seu trabalho, calculou a coesão léxica de uma janela de palavras usando \textit{spreading activation} em uma rede semântica especialmente elaborada para o idioma Inglês. Contudo, sua adaptação para outros domínios dependia da construção de uma rede adequada. 
