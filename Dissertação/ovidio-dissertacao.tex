...
% Recuperação de Informação em atas de reunião utilizando Segmentação Texutal e Extração de Tópicos.

\titulo{Recuperação de informação em atas de reunião utilizando segmentação textual e extração de tópicos}
...
\hypersetup{
		...
		pdftitle={\@title}, 
		% pdfauthor={\@author},
		pdfauthor={Ovídio José Francisco},
    	pdfsubject={\imprimirpreambulo},
	    pdfcreator={LaTeX with abnTeX2},
		pdfkeywords={Recuperação de informação;}{Segmentação Textual;}{Extração de tópicos;}{Atas de reunião.}, 
...
% \include{conteudo/capitulos/1-prefacio}
\include{conteudo/capitulos/2-cap1}
\include{conteudo/capitulos/3-cap2}
\include{conteudo/capitulos/4-cap3}
\include{conteudo/capitulos/cap-avaliacao-segmentadores}
\include{conteudo/capitulos/cap-avaliacao-extratores}
% \include{conteudo/capitulos/cap-avaliacao-modulo-consulta}
\include{conteudo/capitulos/5-conclusao}
% ---------------------------------------------------------- 
...
\include{conteudo/capitulos/6-apendice1}
\include{conteudo/capitulos/6-apendice2}
\include{conteudo/capitulos/6-apendice3}
