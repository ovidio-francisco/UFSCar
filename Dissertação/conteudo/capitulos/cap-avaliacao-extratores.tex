...
Os resultados desses cenários foram apresentados a um grupo de usuários que individualmente avaliaram a qualidade de consultas à coleção de documentos a partir das técnicas de extração de tópicos analisadas nessa avaliação, ou seja, cada indivíduo avaliou 3 cenários distintos.
