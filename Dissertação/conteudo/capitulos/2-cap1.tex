...
Contudo, a segmentação textual apenas indica as transições de assuntos ao longo do texto,  produz trechos com um assunto principal e relativamente independente do texto integral. O assunto de cada trecho pode ser estimado por meio de técnicas de extração de tópicos. 
