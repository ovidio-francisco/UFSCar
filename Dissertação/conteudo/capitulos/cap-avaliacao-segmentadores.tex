...
Inicialmente realizou-se uma avaliação objetiva 	d
em seguida escolheu-se um modelo que apresenta melhores resultados para ser utilizado em conjunto com técnicas de extração de tópicos em um experimento onde se avaliará a performance de ambas as técnicas.
