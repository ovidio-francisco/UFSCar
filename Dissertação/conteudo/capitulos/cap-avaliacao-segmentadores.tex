...
% Os arquivos gerados foram tratados para que os segmentos sempre terminem em uma sentença reconhecida pelo algoritmo, uma vez que as sentenças são a unidade mínima de informação neste trabalho.
...
% Mostrar o teste,
% mostrar que o BS se sobressai.
% mostrar a configuração do BS

% No final falar que o BS foi escolhido.
...
Após a análise dos métodos, selecionou-se o algoritmo \textit{BayesSeg} para a tarefa de segmentação textual neste trabalho. 
