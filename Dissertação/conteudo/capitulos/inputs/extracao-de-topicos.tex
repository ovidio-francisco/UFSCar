...
\noindent
na qual $E$ é a somatória dos erros quadráticos calculados para cada documento da coleção, $x$ é o vetor de atributos que representa o documento, e $mi$ é o centroide ao que representa o grupo $C_i$.
